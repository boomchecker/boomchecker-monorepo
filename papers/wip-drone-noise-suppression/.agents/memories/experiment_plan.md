...
- `to-verify`: Any numeric claim carried over from the internal Czech report (`scripts/lms-filter/report/main.tex`) must be re-verified/re-run before being cited in the English paper.
