...
\title{Ego-Noise Suppression for Impulsive Acoustic Event Detection on Multirotor UAVs\\\thanks{Draft skeleton. Target venue, title, funding note, and author list to be finalized before submission.}}
...
% The skeleton cites nothing yet; \nocite{*} keeps bibtex and the empty
% thebibliography environment from erroring out. Delete it once the prose
% carries real \cite commands.
\nocite{*}
