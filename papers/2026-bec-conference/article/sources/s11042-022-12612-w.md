...
- Relevantní argument pro robustnost bez kontrolované akviziční geometrie (single-channel, unknown setup).
- CNN přístup na „wild“ datech (YouTube) je dobrý kontrast k laboratornějším datasetům.
- Vhodné jako podpora tvrzení, že deployment-realistic data mohou měnit výkonnostní očekávání.
