...
> and in general audio work it is known to be more robust to noise than MFCC – and that
> carries over here. We did not isolate the mechanism in
...
> points. That statement is about the study as a whole: across all
...
stage in the BEC 2026 paper). No appendix slide – it is one sentence.
