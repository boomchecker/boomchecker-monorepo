...
\cue{5:20}{Features}{%
  \say{Now to the main part -- classification. We compared four different cepstral feature
  extractors.}
  ...
  too) $|$ LFCC linear $|$ IMFCC inverted mel, dense high $|$ \textbf{\color{accent}GTCC
  gammatone}, model of human hearing, more noise-robust $|$ (grid $4\times3\times2$ is on the slide)}
