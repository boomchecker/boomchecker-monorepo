...
| `figs/` | `gunshot_char.png`, `tdoa.png`, the filter-bank thumbnails `fb_*.pdf` (generated by `scripts/generate_filterbank_icons.py`), logos (`imeko-logo.png`, `electrical_engeneering_negativ.pdf`) and the title background `title-bg.png` |
