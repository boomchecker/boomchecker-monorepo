 ...
 *          of flash (two 8K sectors) this firmware's linker script reserves
 *          for it (STM32H563xx_FLASH.ld, PR 4 Phase B).
 ******************************************************************************
 */
 ...
 * config sectors. Safe to call at any point in boot - unlike
