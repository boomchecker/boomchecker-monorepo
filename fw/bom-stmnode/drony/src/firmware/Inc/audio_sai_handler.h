...
/**
 * @brief Initializes the audio processing pipeline (MFCC tables, SVM classifier).
 ...
 * @details Decimates 48 kHz -> 16 kHz by keeping every 3rd sample. The input
 *          must already be band-limited to 8 kHz (the pdm_pcm.c FIR does this).
