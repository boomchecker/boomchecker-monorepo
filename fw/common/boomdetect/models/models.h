...
/* Generated by `bdtrain export` from training run r2 (2026-09-06): the model
   of each family that generalised best to the unseen Halmstad recordings, so
   the board can score the same audio with each. Not deployed: the default
   stays mlp_v6 until field recordings decide otherwise. */
extern const classifier_t classifier_svm_l1;
