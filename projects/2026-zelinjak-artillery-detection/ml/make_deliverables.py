...
HARDWARE_VALIDATION_ROOT = PROJECT_ROOT / "hardware_validation" / "esp32s3"
...
# board in CI) - loader below tolerates their absence. Committed under hardware_validation/
# (not gitignored, unlike generated/) since a physical board can't be regenerated by any script.
...
def load_esp32_comparison_stats() -> dict | None:
    ...
    for variant, filename in ESP32_PER_SAMPLE_FILES.items():
        esp_path = HARDWARE_VALIDATION_ROOT / filename
