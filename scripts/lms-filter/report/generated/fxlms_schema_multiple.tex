...
\node[below] at ($(Chat.east)!0.45!(mul.west)$) {\scriptsize $X$};
...
% Dimensions
\node[below=1mm of x] {\scriptsize $\mathbf{x}\in\mathbb{R}^{X}$};
\node[below=1mm of G] {\scriptsize $\mathbf{G}: X\times X$};
\node[below=1mm of C] {\scriptsize $\mathbf{C}: M\times X$};
